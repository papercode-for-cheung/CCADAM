...
# 读取CSV文件
df = pd.read_csv(os.path.join('.', 'PNOS', 'DDinter2.0.csv'))
...
train.to_csv(os.path.join('.','PNOS','DDinter2.0_train.csv'), index=False)
val.to_csv(os.path.join('.','PNOS','DDinter2.0_valid.csv'), index=False)
test.to_csv(os.path.join('.','PNOS','DDinter2.0_test.csv'), index=False)
