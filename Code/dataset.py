...
class twosides_pkl(Dataset):
    def __init__(self, data_dir,):
        ...
        while line:
            ...
            self.drug_info[int(id1)] = {'smiles': smiles1}
            self.drug_info[int(id2)] = {'smiles': smiles2}
    ...
    def collate_fn(self, batch):
        ...
        for data in batch:
            ...
            #     continue
            # a = data['drug_1']
            id_list.append(drug1)
            id_list2.append(drug2)
            # 
            ...
            Drug1 = Data(x=x_1, edge_index=edge_index_1, edge_attr=edge_feature_1,drug_id=drug1)
            x_2, edge_index_2, edge_feature_2 = self.drugdata[drug2]

            Drug2 = Data(x=x_2, edge_index=edge_index_2, edge_attr=edge_feature_2,drug_id=drug2)
    ...
    def get_rel_max(self):
        # 获取所有 interaction 的最大值
        rel_max = max([int(data[2]) for data in self.DDI_index])
        return rel_max
